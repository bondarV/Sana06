...
try
{
    ...
    peoples[1] = new Applicant("Valentun", "Bilyy", new DateTime(2000, 10, 12), 190F, 103F, "ZTU");
...
catch(NumOfPntsForAnEduDocException ex)
{
    Console.WriteLine(ex.Message);
    Console.WriteLine($"!!!!!Зверніть увагу з якого ви діапазону ввели значення ---> {ex.NumOfPntsForAnEduDoc}") ;
}
